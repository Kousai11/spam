...
var server = "478128126552047616"; // ايدي السررفر
var channel = "512703280476979200";//ايدي الروم
    setInterval(()=>{
...
client.login(process.env.NDYyMjU0MzI4NjkxMDMyMDY1.Ds36hQ.A520pcE41Yby9aX_fnmEM7iYo8A);
